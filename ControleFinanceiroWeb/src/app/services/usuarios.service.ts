import { AtualizarUsuario } from './../models/atualizarUsuario.model';
import { DadosLogin } from './../models/dadosLogin.model';
import { DadosRegistro } from './../models/dadosRegistro.model';
...
export class UsuariosService {
  ...
  BuscarUsuarioPorId(id: string): Observable<AtualizarUsuario> {
