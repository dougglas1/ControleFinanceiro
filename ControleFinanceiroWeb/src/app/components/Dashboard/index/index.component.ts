...
export class IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.dashboardService
      .BuscarDadosCardsDashboard(this.usuarioId)
      .subscribe((resultado) => {
    ...
    this.dashboardService
      .BuscarDadosAnuaisPorUsuarioId(this.usuarioId, this.anoAtual)
      .subscribe((resultado) => {
  ...
  CarregarDados(anoSelecionado: number): void {
    this.dashboardService
      .BuscarDadosAnuaisPorUsuarioId(this.usuarioId, anoSelecionado)
      .subscribe((resultado) => {
        this.labels = this.RetornarMeses(resultado.meses);
